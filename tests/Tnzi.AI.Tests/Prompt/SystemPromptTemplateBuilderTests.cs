...
public class SystemPromptTemplateBuilderTests
{
    ...
    [Fact]
    public void Build_SingleSection_WrapsInXmlTag()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void Build_MultipleSections_OrderedByOrderValue()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void Build_NullOrEmptyContent_SkipsSection()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void Build_DuplicateTag_LastWins()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void Build_All13Sections_ContainsAllTags()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void AddSectionProvider_IntegratesProviderOutput()
    {
        var builder = new SystemPromptTemplateBuilder();
    ...
    [Fact]
    public void RemoveSection_RemovesTag()
    {
        var builder = new SystemPromptTemplateBuilder();
        builder.AddSection("soul", "persona", order: 0);
        builder.AddSection("memory", "memories", order: 20);
    ...
    {
        public SystemPromptSection? GetSection() => new(tag, content, order);
    }
}
