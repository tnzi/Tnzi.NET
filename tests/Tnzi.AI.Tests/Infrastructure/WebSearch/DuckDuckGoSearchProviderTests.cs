using System.Net;
using DuckDuckGoSearchProvider = Tnzi.AI.Infrastructure.WebSearch.DuckDuckGoSearchProvider;
...
public class DuckDuckGoSearchProviderTests
{
    private DuckDuckGoSearchProvider CreateProvider(HttpMessageHandler handler)
    {
        ...
        factory.Setup(f => f.CreateClient("Tnzi.AI.DuckDuckGo")).Returns(httpClient);
