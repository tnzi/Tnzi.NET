...
///  50  ThreadData → 55 Sandbox → 60 FileUpload → 75 PromptCaching → 80 Thinking
/// → 100 Retry → 200 InputGuardrail → 300 History → 350 Summarization
/// → 400 ContextInjection → 420 Todo → 450 SkillConstraint → 500 UsageLogging
/// → 550 SubAgentLimit → 600 Quota → 630 ViewImage → 640 DeferredToolFilter
...
public static class AiMiddlewareOrders
{
    ...
    /// <summary>Prompt 缓存标记注入 (Phase 2 enhanced)</summary>
