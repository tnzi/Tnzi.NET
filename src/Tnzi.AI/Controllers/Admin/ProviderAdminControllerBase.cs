...
public abstract class ProviderAdminControllerBase : ApiAdminControllerBase
{
    protected readonly IChatClientFactory ClientFactory;

    /// <summary>
    /// 初始化 Provider 管理控制器基类
    /// </summary>
    protected ProviderAdminControllerBase(IChatClientFactory clientFactory)
    {
