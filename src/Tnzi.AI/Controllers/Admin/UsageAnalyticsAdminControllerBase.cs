...
public abstract class UsageAnalyticsAdminControllerBase : ApiAdminControllerBase
{
    ...
    /// 初始化使用量分析管理控制器基类
    /// </summary>
    protected UsageAnalyticsAdminControllerBase(IUsageAnalyticsService analyticsService)
    {
