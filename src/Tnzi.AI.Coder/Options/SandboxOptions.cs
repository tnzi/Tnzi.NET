...
public class SandboxOptions
{
    ...
    /// 拒绝执行的命令列表
    /// </summary>
    public List<string> DeniedCommands { get; set; } = ["rm -rf /", "format c:", "mkfs"];
    ...
    /// 文件最大读取大小（字节，默认 10MB）
    /// </summary>
    public long MaxFileReadSize { get; set; } = 10_485_760;

    /// <summary>
    /// 输出最大大小（字节，默认 100KB）
    /// </summary>
    public long MaxOutputSize { get; set; } = 102_400;
    ...
    /// 最大同时后台进程数
    /// </summary>
    public int MaxBackgroundProcesses { get; set; } = 5;
}
