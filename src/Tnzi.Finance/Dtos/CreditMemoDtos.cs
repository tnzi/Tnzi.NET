...
public class CreditMemoDto
{
    ...
    public List<CreditMemoLineDto> Lines { get; set; } = new();
}
...
public class CreateCreditMemoDto
{
    ...
    public string? Memo { get; set; }
    public List<CreateCreditMemoLineDto> Lines { get; set; } = null!;
}

/// <summary>
/// 销售贷项单行请求
/// </summary>
public class CreateCreditMemoLineDto
{
    public Guid? ItemId { get; set; }
    public string? Description { get; set; }
...
/// 销售贷项单查询请求
/// </summary>
public class CreditMemoQueryDto : PagedQueryDto
{
