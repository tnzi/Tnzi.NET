...
public abstract class AuditOperationAdminControllerBase : ApiAdminControllerBase
{
    ...
    protected AuditOperationAdminControllerBase(IAuditOperationService auditOperationService)
    {
