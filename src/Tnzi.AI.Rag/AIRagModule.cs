...
public class AIRagModule : TnziApplicationModule
{
    /// <summary>
    /// 在 AIModule(50) 之后加载
    /// </summary>
    ...
    public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
    {
        ...
        if (embeddingCacheEnabled)
        {
            ...
            services.AddKeyedScoped<IEmbeddingService, EmbeddingService>(CachingEmbeddingDecorator.InnerServiceKey);
    ...
    public override Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        var logger = serviceProvider.GetRequiredService<ILogger<AIRagModule>>();
