...
public abstract class SubscriptionAdminControllerBase : ApiAdminControllerBase
{
    private readonly ISubscriptionService _subscriptionService;

    protected SubscriptionAdminControllerBase(ISubscriptionService subscriptionService)
    {
