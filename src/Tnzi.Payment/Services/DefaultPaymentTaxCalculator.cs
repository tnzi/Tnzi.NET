...
/// 多辖区、跨境、B2B 反向征收等规则由应用注册自己的 <see cref="IPaymentTaxCalculator"/> 承接，
/// 框架不内置任何国家的税表内容。
/// </remarks>
public class DefaultPaymentTaxCalculator : IPaymentTaxCalculator
{
    private readonly IOptionsMonitor<TaxOptions> _taxOptions;

    public DefaultPaymentTaxCalculator(IOptionsMonitor<TaxOptions> taxOptions)
    {
