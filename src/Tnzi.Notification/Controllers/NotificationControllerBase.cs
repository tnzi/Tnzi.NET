...
public abstract class NotificationControllerBase : ApiControllerBase
{
    protected readonly IUserNotificationService UserNotificationService;

    protected NotificationControllerBase(IUserNotificationService userNotificationService)
    {
