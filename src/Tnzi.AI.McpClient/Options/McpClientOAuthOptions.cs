namespace Tnzi.AI.McpClient.Options;

/// <summary>
/// MCP Client OAuth 配置 — 用于本框架作为 MCP Client 连接外部 MCP Server 时的 OAuth 凭证管理
/// </summary>
public class McpClientOAuthOptions
{
    /// <summary>每个 MCP Server 的 OAuth 配置，key 为 server name</summary>
