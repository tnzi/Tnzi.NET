namespace Tnzi.AI.McpClient.Services;
...
///   由 AIModule.AddDataProtection() 注册，AIMcpClientModule 通过 [DependsOn(typeof(AIModule))]
///   自动获取。
///
...
///
/// 重要：本服务的 CRUD 表面是独立的，MCP 运行时连接路径目前仍读取 McpOptions（AI 核心配置）；
/// 实体 → 运行时绑定为后续工作。
/// </remarks>
