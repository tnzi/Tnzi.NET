...
/// </summary>
public abstract class LoginSecurityAdminControllerBase : ApiAdminControllerBase
{
    ...
    protected LoginSecurityAdminControllerBase(ILoginSecurityService loginSecurityService)
    {
