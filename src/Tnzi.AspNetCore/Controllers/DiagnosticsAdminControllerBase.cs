...
public abstract class DiagnosticsAdminControllerBase : ApiAdminControllerBase
{
    ...
    protected DiagnosticsAdminControllerBase(IExceptionStatisticsService exceptionStatisticsService)
    {
