namespace Tnzi.Localization.Permissions;

/// <summary>
/// Operation-level permission codes for the Localization module's admin surfaces.
/// </summary>
/// <remarks>
...
/// </remarks>
public class LocalizationPermissions : IPermissionDefinitionProvider
{
    public void Define(IPermissionDefinitionContext context)
    {
        ...
        context.AddCrudPermissions("system.localization", "Localization", parentName: "system", actions: CrudActions.View | CrudActions.Delete);
    }
}
