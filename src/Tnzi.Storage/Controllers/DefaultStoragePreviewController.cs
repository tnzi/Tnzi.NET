...
[DefaultController]
public class DefaultStoragePreviewController : ApiControllerBase
{
    ...
    public DefaultStoragePreviewController(IFilePreviewService filePreviewService, IFileStorageService fileStorageService)
    {
