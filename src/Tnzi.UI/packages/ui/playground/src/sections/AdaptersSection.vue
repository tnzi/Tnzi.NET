<template>
  <div class="section-page">
    ...
    <div class="demo-block">
      ...
      <p class="demo-desc">createMessageAdapter wraps Naive UI's useMessage API.</p>
    ...
    <div class="demo-block">
      ...
      <p class="demo-desc">createDialogAdapter wraps Naive UI's useDialog API.</p>
      <PreviewBox :no-badge :full-width>
    ...
    <div class="demo-block">
      ...
      <p class="demo-desc">createThemeAdapter manages dark/light mode on the document element.</p>
      <PreviewBox :no-badge :full-width>
...
const dlgAdapter = createDialogAdapter(dialog);
