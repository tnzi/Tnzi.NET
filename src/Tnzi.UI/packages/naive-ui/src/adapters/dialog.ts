 ...
 * setDialogAdapter(createNaiveDialogAdapter(dialogApi));
 * ```
 */
export function createNaiveDialogAdapter(dialogApi?: NaiveDialogApi): DialogAdapter {
  return {
