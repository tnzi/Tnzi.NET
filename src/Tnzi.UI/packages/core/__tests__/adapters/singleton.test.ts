...
import { createAdapterSingleton } from '../../src/adapters/singleton';
import { setMessageAdapter, useMessage, resetMessageAdapter, type MessageAdapter } from '../../src/adapters/message';
