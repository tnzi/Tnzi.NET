/**
 * @tnzi/core/playground/theme-utils
 *
 * 将 ThemeConfig 应用到 DOM CSS 自定义属性的工具函数。
 */

import type { ThemeConfig, ThemeColors, ThemeMode } from '../types/theme';
import { lightThemeColors, darkThemeColors, defaultThemeConfig } from '../types/theme';
