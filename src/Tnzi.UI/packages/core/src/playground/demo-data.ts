/**
 * @tnzi/core/playground/demo-data
 *
 * 共享 mock 数据，供各 playground 统一使用。
 */

import type { IMenuItem } from '../components/layout';
import type { ITableColumn } from '../components/table';
import type { IDynamicFormField, IFormRule } from '../components/form';
import type { ITabItem, IBreadcrumbItem } from '../components/navigation';
import type { IUserCardProps, IStatCardProps } from '../components/card';
...
export const demoUsers: IUserCardProps['user'][] = [
...
export const demoStatCards: IStatCardProps[] = [
