 ...
 *
 * Uses ResizablePanels for adjustable layout. Sidebar collapsible on mobile via Sheet.
 */

import { ref, computed } from 'vue';
import { cn } from '@/lib/utils';
import { ResizableHandle, ResizablePanel, ResizablePanelGroup } from '@/primitives/ui/resizable';
import { Sheet, SheetContent } from '@/primitives/ui/sheet';
