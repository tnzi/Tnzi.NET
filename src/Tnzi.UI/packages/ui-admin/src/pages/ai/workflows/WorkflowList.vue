<template>
  <!--
    WorkflowList — workflow definition CRUD landing page (Phase J overhaul).
  ...
  <!-- Run modal: collect a single text input and POST to /workflows/{id}/run.
       ...
       streaming-trace UI lives on the RunViewer page where the user
       can also Resume / Approve / Reject. -->
  <NModal v-model:show="runModal.show" :title="runModalTitle" preset="card" style="max-width: 560px">
...
import { workflowColumns, workflowFormSchema } from './workflow-list-config'
import type {
