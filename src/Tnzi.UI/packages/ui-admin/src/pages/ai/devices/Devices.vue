<template>
  <!--
    Devices — surfaces /admin/devices* exposed by `Tnzi.AI.Device`.
    Two tabs:
...
const deviceColumns: DataTableColumns<DeviceNodeDto> = [
  ...
  },
  {
    ...
    width: 220,
    render: (row) =>
      h('code', { class: 'font-[family-name:var(--tnzi-font-mono)] text-11px' }, row.nodeId),
  },
  {
...
const pairingColumns: DataTableColumns<PairingRequestDto> = [
  ...
  },
  {
    ...
    align: 'right',
    render: (row) =>
      h('div', { class: 'flex justify-end gap-6px' }, [
        h(
          NButton,
