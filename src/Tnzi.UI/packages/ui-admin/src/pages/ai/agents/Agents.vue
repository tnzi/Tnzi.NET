<template>
  <!--
    Agents — Phase 5 canonical AI admin page (Task 5.2).
...
import { agentColumns, agentFormSchema } from './agent-config'
import type {
  AgentDto,
  CreateAgentDto,
  UpdateAgentDto,
...
const rowActions: RowAction<AgentDto>[] = [editAction(crud), deleteAction(crud)]
