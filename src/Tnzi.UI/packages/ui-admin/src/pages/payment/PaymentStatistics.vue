<template>
  <!--
    PaymentStatistics — revenue overview + trend + subscription metrics
  ...
  <div class="t-pay-stats-page">
    <div class="t-pay-stats-page__header">
      <div class="t-pay-stats-page__title">
        <TSvgIcon icon="mdi:chart-line" :size="20" />
        <h2>{{ t('title') }}</h2>
      </div>
      <div class="t-pay-stats-page__toolbar">
        <NSelect
...
.t-pay-stats-page__title {
  display: flex;
  align-items: center;
  gap: 8px;
}
.t-pay-stats-page__title h2 {
  margin: 0;
  font-size: 18px;
  font-weight: 600;
}
.t-pay-stats-page__toolbar {
  display: flex;
  align-items: center;
  gap: 8px;
  flex-wrap: wrap;
