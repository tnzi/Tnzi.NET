...
import { useAdminUserCenterConfig } from '../../plugin/user-center-config'
import { createUserCenterState, provideUserCenterContext } from './user-center-context'
import { DETAIL_ACTIVE_SECTION_ICON } from '../../components/detail/active-section-icon'
import { resolveUserCenterSections, type UserCenterBuiltInDef } from './resolve-sections'
