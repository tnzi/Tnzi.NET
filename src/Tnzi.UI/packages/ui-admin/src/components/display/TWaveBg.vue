...
import { getPaletteColorByNumber } from '@tnzi/ui'
 ...
 * blobs overflow the viewport so the visible portion looks like soft
...
<template>
  <div class="absolute inset-0 z-1 size-full overflow-hidden pointer-events-none" aria-hidden="true">
    <div class="absolute -right-300px -top-900px lt-sm:(-right-100px -top-1170px)">
      <svg height="1337" width="1337" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <path
            id="t-wave-path-1"
            opacity="1"
          ...
          />
          <linearGradient id="t-wave-gradient-1" x1="0.79" y1="0.62" x2="0.21" y2="0.86">
            <stop offset="0" :stop-color="lightColor" stop-opacity="1" />
            <stop offset="1" :stop-color="darkColor" stop-opacity="1" />
          </linearGradient>
        </defs>
        <g opacity="1">
          <use href="#t-wave-path-1" fill="url(#t-wave-gradient-1)" fill-opacity="1" />
        </g>
      </svg>
    </div>
    <div class="absolute -bottom-400px -left-200px lt-sm:(-bottom-760px -left-100px)">
      <svg height="896" width="967.8852157128662" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <path
            id="t-wave-path-2"
            opacity="1"
          ...
          />
          <linearGradient id="t-wave-gradient-2" x1="0.5" y1="0" x2="0.5" y2="1">
            <stop offset="0" :stop-color="darkColor" stop-opacity="1" />
            <stop offset="1" :stop-color="lightColor" stop-opacity="1" />
          </linearGradient>
        </defs>
        <g opacity="1">
          <use href="#t-wave-path-2" fill="url(#t-wave-gradient-2)" fill-opacity="1" />
        </g>
      </svg>
    </div>
  </div>
