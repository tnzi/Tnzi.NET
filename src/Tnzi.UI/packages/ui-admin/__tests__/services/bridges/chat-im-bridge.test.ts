...
function mockApi() {
  return {
    getConversations: vi.fn(async () => ({ success: true, code: 200, data: [{ id: 'c1', type: 'Direct', title: 'Alice', unreadCount: 2, isMuted: false, memberCount: 2 }] })),
    getMessages: vi.fn(async () => ({ success: true, code: 200, data: { messages: [{ id: 'm1', conversationId: 'c1', contentType: 'Text', content: 'hi', sentAt: '2026-01-01T00:00:00Z' }], hasMore: false } })),
    sendMessage: vi.fn(async () => ({ success: true, code: 200, data: { id: 'm2', conversationId: 'c1', contentType: 'Text', content: 'yo', sentAt: '2026-01-01T00:00:01Z' } })),
