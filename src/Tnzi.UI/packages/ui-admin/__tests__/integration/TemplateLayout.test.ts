...
describe('TemplateLayout page (Phase 3.37)', () => {
  beforeEach(() => { setActivePinia(createPinia()) })

  it('mounts without throwing', async () => {
    const { default: TemplateLayout } = await import('../../src/pages/template/TemplateLayout.vue')
    const wrapper = mount(TemplateLayout, { global: { stubs } })
    await nextTick()
