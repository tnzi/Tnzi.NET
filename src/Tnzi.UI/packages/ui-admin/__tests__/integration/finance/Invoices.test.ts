...
vi.mock('vue-router', () => ({
  useRoute: () => ({ query: routeQuery.current, params: {}, path: '/admin/finance/invoices', fullPath: '/admin/finance/invoices', hash: '', name: 'finance.invoices', meta: {} }),
...
describe('Finance Invoices page', () => {
  ...
  // The customer work surface hands off with `?entry=new&party=<id>`. `new` is
  ...
  it('opens a pre-filled draft from a customer hand-off', async () => {
