...
/**
 * Vendors page — standard TCrudPage over the finance bridge.
 */
...
vi.mock('vue-router', () => ({
  useRoute: () => ({ query: {}, params: {}, path: '/admin/finance/vendors', fullPath: '/admin/finance/vendors', hash: '', name: 'finance.vendors', meta: {} }),
  useRouter: () => ({ push: vi.fn(), replace: vi.fn(), back: vi.fn() }),
}))

const fetchList = vi.fn(async () => ({ items: [{ id: 'v1', name: 'Supplies Co', isActive: true }], totalCount: 1, pageIndex: 1, pageSize: 20 }))
...
import Page from '../../../src/pages/finance/Vendors.vue'
