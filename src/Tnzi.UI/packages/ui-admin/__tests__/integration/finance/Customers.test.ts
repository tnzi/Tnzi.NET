...
/**
 * Customers page — standard TCrudPage over the finance bridge.
 */
...
vi.mock('vue-router', () => ({
  useRoute: () => ({ query: {}, params: {}, path: '/admin/finance/customers', fullPath: '/admin/finance/customers', hash: '', name: 'finance.customers', meta: {} }),
  useRouter: () => ({ push: vi.fn(), replace: vi.fn(), back: vi.fn() }),
}))

const fetchList = vi.fn(async () => ({ items: [{ id: 'c1', name: 'Acme', isActive: true }], totalCount: 1, pageIndex: 1, pageSize: 20 }))
...
import Page from '../../../src/pages/finance/Customers.vue'
...
describe('Finance Customers page', () => {
  beforeEach(() => {
