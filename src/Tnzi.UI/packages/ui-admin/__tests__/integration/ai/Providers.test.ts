...
/**
 * Phase 5 Task 5.8 — Providers integration test.
 * Mirrors Knowledge.test.ts (CRUD + reindex/test action canonical pattern).
 */
...
describe('Providers page (Phase 5 Task 5.8)', () => {
  beforeEach(() => {
