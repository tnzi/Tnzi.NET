...
/**
 * Phase 5 Task 5.2 — Agents canonical page integration test.
 *
...
vi.mock('../../../src/services/bridges/ai-bridge', () => ({
  createAiBridge: () => ({
    ...
    // The bridge surface has 13 sub-contracts; Agents only exercises `agents`.
...
describe('Agents page (Phase 5 canonical AI page)', () => {
  // Agents consumes translatePageKey() which reads useAdminAppStore()
