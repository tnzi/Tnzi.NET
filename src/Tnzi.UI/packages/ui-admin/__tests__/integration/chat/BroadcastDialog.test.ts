...
const broadcasts = vi.fn(async () => ({
  items: [
    { id: 'b1', content: 'hello all', targetType: 1, targetSummary: 'All users', recipientCount: 5, senderId: null, senderName: 'admin', creationTime: '2026-01-01T00:00:00Z' },
  ],
  totalCount: 1,
  pageIndex: 1,
  pageSize: 5,
...
import BroadcastDialog from '../../../src/pages/chat/BroadcastDialog.vue'
