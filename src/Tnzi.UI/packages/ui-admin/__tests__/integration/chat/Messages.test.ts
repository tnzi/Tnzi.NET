...
describe('Messages page (Phase 3.30)', () => {
  beforeEach(() => { setActivePinia(createPinia()) })

  it('mounts without throwing', async () => {
    const { default: Messages } = await import('../../../src/pages/chat/Messages.vue')
...
describe('chatMessageColumns config', () => {
  it('exports columns with required keys', async () => {
    ...
    const { chatMessageColumns } = await import('../../../src/pages/chat/message-config')
  ...
  it('exports formSchema with required fields', async () => {
    const { chatMessageFormSchema } = await import('../../../src/pages/chat/message-config')
