...
/**
 * Phase 5 Task 5.7 — SkillList integration test.
...
describe('SkillList page (Phase 5 Task 5.7)', () => {
  beforeEach(() => {
    setActivePinia(createPinia())
  })

  it('mounts, fetches skills on mount, and displays rows', async () => {
    const wrapper = mount(SkillList, { global: { stubs } })
    await flushPromises()
  ...
  it('page title contains "Skills"', async () => {
    const wrapper = mount(SkillList, { global: { stubs } })
    await flushPromises()
