...
describe('NotificationMessage page (Phase 3.26)', () => {
  beforeEach(() => { setActivePinia(createPinia()) })

  it('mounts without throwing', async () => {
    const { default: NotificationMessage } = await import('../../src/pages/notification/NotificationMessage.vue')
    const wrapper = mount(NotificationMessage, { global: { stubs } })
    await nextTick()
