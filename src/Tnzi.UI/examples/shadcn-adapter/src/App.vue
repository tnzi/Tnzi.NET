    ...
    <div class="pg-main-layout">
      ...
      <div class="pg-content-area">
        ...
        <main class="pg-main">
          ...
          <FeedbackSection v-else-if="activeKey === 'feedback'" />
...
import { DialogProvider, MessageContainer, NotificationContainer } from '@/components';
import { LoadingBar } from '@/components';
import { resolveThemeMode } from '@/playground';
...
const iconMap: Record<string, string> = {
  ...
  feedback: 'material-symbols:notifications-active',
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'feedback', label: 'Feedback', icon: iconMap.feedback },
