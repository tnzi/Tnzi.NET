<template>
  <div class="space-y-4">
    ...
    <Card>
      ...
      <CardContent>
        <NativeSelect
          :model-value="themeConfig.fontFamily"
          wrapper-class="w-full"
          @update:model-value="updateProperty('fontFamily', $event as string)"
        >
          <NativeSelectOption v-for="opt in fontFamilyOptions" :key="opt.value" :value="opt.value">
            {{ opt.label }}
          </NativeSelectOption>
        </NativeSelect>
      </CardContent>
...
import { themePresets, fontFamilyOptions } from '@/playground';
import {
