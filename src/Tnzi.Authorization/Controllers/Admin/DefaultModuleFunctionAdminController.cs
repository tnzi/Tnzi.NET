...
public class DefaultModuleFunctionAdminController : ApiAdminControllerBase
{
    ...
    public DefaultModuleFunctionAdminController(IModuleManagementService moduleManagementService)
    {
