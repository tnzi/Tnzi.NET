namespace Tnzi.AI.Skills.Permissions;

/// <summary>
/// Operation-level permission codes for the AI Skills sub-module's admin surfaces.
/// </summary>
/// <remarks>
...
/// </remarks>
public class AISkillsPermissions : IPermissionDefinitionProvider
{
    public void Define(IPermissionDefinitionContext context)
    {
        ...
        context.AddCrudPermissions("ai.skill", "Skills", parentName: "ai");
    }
}
