...
Read all the skills listed in the available skills context.
...
- Juxtapose skills in unexpected ways (e.g., a presentation about algorithmic art, a research report turned into a slide deck, a styled doc with designed illustrations)
...
- **Good reveal:** A brief teaser + the artifact
- **Bad reveal:** Explaining which skills were combined and why before showing anything (kills the surprise)
