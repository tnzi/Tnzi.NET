...
| Framework | Description | Best For |
|-----------|-------------|----------|
| **DuPont Analysis** | ROE = Net Profit Margin x Asset Turnover x Equity Multiplier | Profitability decomposition, financial health diagnosis |
...
| **GE-McKinsey Matrix** | Industry Attractiveness x Competitive Strength | Business portfolio prioritization, investment decisions |
...
3. **Delegate to Visualization Skill**: Invoke the available visualization/charting skill for each chart task with:
